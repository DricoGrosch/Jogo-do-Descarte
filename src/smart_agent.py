...
class SmartAgent(Agent):
    ...
    def handle_strategy(self, environment):
        ...
        for neighbor in node_neighbors:
            self.graph.visual_graph.add_edge(self.graph.get_node_representation(environment.hand),
                                             self.graph.get_node_representation(neighbor['node']))
